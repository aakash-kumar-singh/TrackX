...
const sendVerificationEmail = async (user, verificationUrl) => {
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <tr>
          <td style="background-color: #5469d4; padding: 30px; text-align: center;">
            <h1 style="color: white; margin: 0; font-size: 28px;">Welcome to TrackX</h1>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding: 40px 30px;">
            ...
            <p style="font-size: 16px; line-height: 1.6; margin-bottom: 25px;">Thanks for signing up with TrackX! To get started, please verify your email address by clicking the button below:</p>
            ...
            <p style="font-size: 16px; line-height: 1.6; margin-bottom: 25px;">The TrackX Team</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background-color: #f7f9fc; padding: 20px 30px; text-align: center; border-top: 1px solid #eaeaea;">
            <p style="font-size: 14px; color: #666; margin-bottom: 10px;">© ${new Date().getFullYear()} TrackX. All rights reserved.</p>
  ...
  await sendEmail({
    email: user.email,
    subject: "Verify Your Email - TrackX",
    html,
  });
};
...
const sendResetPasswordEmail = async (user, resetToken) => {
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <tr>
          <td style="padding: 40px 30px;">
            ...
            <p style="font-size: 16px; line-height: 1.6; margin-bottom: 25px;">We received a request to reset your password for your TrackX account. Click the button below to create a new password:</p>
          ...
          <td style="padding: 0 30px 30px;">
            <div style="padding: 15px; background-color: #f8f9fa; border-left: 4px solid #ffc107; margin-bottom: 20px;">
              <p style="font-size: 14px; color: #666; margin: 0;">
                <strong>Security Tip:</strong> TrackX will never ask for your password or personal information by email. If you receive any suspicious emails claiming to be from us, please report them.
              </p>
            </div>
          </td>
        </tr>
  ...
  await sendEmail({
    email: user.email,
    subject: "Reset Your Password - TrackX",
    html,
  });
};
